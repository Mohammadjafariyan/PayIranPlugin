...
class FilesApi
{
     ...
     * Create a File
     *
     * @param  \Swagger\Client\Model\FilesBody $body body (optional)
     *
     ...
     * Create a File
     *
     * @param  \Swagger\Client\Model\FilesBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->getFileWithHttpInfo($id, $fields, $meta);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFileAsync($id, $fields = null, $meta = null)
    {
        return $this->getFileAsyncWithHttpInfo($id, $fields, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFileRequest($id, $fields = null, $meta = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getFilesWithHttpInfo($fields, $limit, $offset, $sort, $filter, $search, $meta);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFilesAsync($fields = null, $limit = null, $offset = null, $sort = null, $filter = null, $search = null, $meta = null)
    {
        return $this->getFilesAsyncWithHttpInfo($fields, $limit, $offset, $sort, $filter, $search, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFilesRequest($fields = null, $limit = null, $offset = null, $sort = null, $filter = null, $search = null, $meta = null)
    {
     ...
     *
     * @param  string $id Unique identifier for the object. (required)
     * @param  \Swagger\Client\Model\FilesIdBody $body body (optional)
     * @param  string[] $fields Control what fields are being returned in the object. (optional)
     * @param  string $meta What metadata to return in the response. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
    ...
    {
        list($response) = $this->updateFileWithHttpInfo($id, $body, $fields, $meta);
        return $response;
    }
     ...
     *
     * @param  string $id Unique identifier for the object. (required)
     * @param  \Swagger\Client\Model\FilesIdBody $body (optional)
     * @param  string[] $fields Control what fields are being returned in the object. (optional)
     * @param  string $meta What metadata to return in the response. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFileAsync($id, $body = null, $fields = null, $meta = null)
    {
        return $this->updateFileAsyncWithHttpInfo($id, $body, $fields, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateFileRequest($id, $body = null, $fields = null, $meta = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($multipart) {
            ...
            $headers = $this->headerSelector->selectHeaders(
                ['application/json'],
                ['multipart/data', 'application/json']
            );
        }
