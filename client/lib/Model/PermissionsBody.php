...
/**
 * PermissionsBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PermissionsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'permissions_body';
...
self::UPDATE_FULL,        ];
     ...
     * Sets comment
     *
     * @param string $comment If the user can post comments.
     *
     * @return $this
     */
     ...
     * Sets role
     *
     * @param int $role Unique identifier of the role this permission applies to.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $read_field_blacklist Explicitly denies read access for specific fields.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status What status this permission applies to.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $status_blacklist Explicitly denies specific statuses to be used.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $write_field_blacklist Explicitly denies write access for specific fields.
     *
     * @return $this
     */
