...
//new \Swagger\Client\Model\Users(); // \Swagger\Client\Model\Users |
		...
		try {
			...
			<div class="alert alert-success" role="alert" style="text-align: center">
				...
				می توانید از <a target="_blank" href="http://37.120.222.28:8055/admin/login">لینک ورود</a> به سیستم
				اقدام فرمایید
			...
			<div class="alert alert-danger" role="alert" style="text-align: center">
				<strong>پیغام ناموفق</strong>
ثبت نام انجام نشد
				این ایمیل قبلا ثبت نام شده است لطفا ایمیل دیگری وارد نمایید و یا از برای ورود
					...
					<div class="card text-black" style="border-radius: 25px;">
						<div class="card-body p-md-5">
							<div class="row justify-content-center">
									...
									<form class="mx-1 mx-md-4">
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<input maxlength="50" required="required"
													   oninvalid="validate(this,'لطفا نام خود را وارد نمایید')"
													   name="first_name" value="" type="text" id="form3Example1c"
													   class="form-control"/>
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<input maxlength="50" required="required" name="last_name"
													   oninvalid="validate(this,'لطفا نام خانوادگی خود را وارد نمایید')"
													   value="" type="text" id="form3Example1c"
													   class="form-control"/>
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<input maxlength="50" required="required" dir="ltr"
													   oninvalid="validate(this,'لطفا ایمیل خود را وارد نمایید')"
													   style="text-align:left;direction:ltr" value=""
													   name="email" type="email" id="form3Example3c"
													   class="form-control"/>
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<input maxlength="50" required="required" name="password"
													   oninvalid="validate(this,'لطفا رمز عبور خود را وارد نمایید')"
													   value="" type="password" id="form3Example4c"
													   class="form-control"/>
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<input maxlength="50" required="required" name="confirmpassword"
													   oninvalid="validate(this,'لطفا رمز عبور خود را وارد نمایید')"
													   value="" type="password" id="form3Example4cd"
													   class="form-control"/>
											</div>
										</div>
										...
										<div class="form-check  row d-flex  ">
											...
											<label class="col-10 form-check-label " for="form2Example3">
												...
												<a target="_blank"  href="http://37.120.222.28:8055/admin/login">ورود به سیستم</a>
								...
								<div
									class="col-md-10 col-lg-6 col-xl-7 d-flex flex-column-reverse align-items-center order-1 order-lg-2">
